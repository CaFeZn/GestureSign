...
| [#85](https://github.com/TransposonY/GestureSign/issues/85) | 触摸板延迟、重复和轨迹锯齿仍有一部分取决于驱动/设备，但触摸板/raw-input 处理已继续改进：完整逻辑槽位解析、按设备句柄区分同类输入源，以及让实时多指更新按稳定触点顺序参与计算，能降低部分硬件上“来回抖动”或连续手势方向重复翻转的问题；最终关闭仍需要受影响的 Synaptics 或厂商驱动硬件验证。 |
