...
| [#136](https://github.com/TransposonY/GestureSign/issues/136), [#90](https://github.com/TransposonY/GestureSign/issues/90) | Gesture training help now explains which input sources can draw and when mouse gestures must be enabled first. The training UI can also enable mouse gesture drawing directly with the default right-button configuration when it is currently off. |
