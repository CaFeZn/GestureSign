...
| [#94](https://github.com/TransposonY/GestureSign/issues/94) | Simple pen gestures can now use `Tip` or `Hover` without requiring the barrel/right-click button or inverted pen as a mandatory activation gate. |
