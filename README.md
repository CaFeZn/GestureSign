...
- Conditions are evaluated with Windows virtual screen coordinates. Percent variants are usually better when the same configuration must work across displays with different resolutions.
